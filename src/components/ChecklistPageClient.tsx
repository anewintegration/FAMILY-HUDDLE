    ...
    <div className="w-full px-4 py-5">
      ...
      <form onSubmit={addItem} className="card p-3 flex gap-2 mb-4">
        ...
        <button
          type="submit"
          disabled={busy}
          className="text-white text-sm font-semibold rounded-full px-4"
      ...
      <div className="flex flex-col gap-2">
        ...
        {items.map((item) => (
          <div
            key={item.id}
            className="flex items-center gap-2.5 bg-cream-card border border-cream-border rounded-2xl px-3.5 py-3 shadow-sm"
          >
