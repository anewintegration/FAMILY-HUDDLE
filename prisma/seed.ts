...
const FAMILY = [
  { username: 'dad', displayName: 'Dad', role: 'PARENT' as const, slug: 'dad', color: '#1B2340', password: 'changeme-dad' },
  { username: 'mom', displayName: 'Mom', role: 'PARENT' as const, slug: 'mom', color: '#FF5A36', password: 'changeme-mom' },
  { username: 'benjamin', displayName: 'Benjamin', role: 'CHILD' as const, slug: 'benjamin', color: '#4C86A8', password: 'changeme-ben' },
  { username: 'bradley', displayName: 'Bradley', role: 'CHILD' as const, slug: 'bradley', color: '#FFB238', password: 'changeme-brad' },
]
